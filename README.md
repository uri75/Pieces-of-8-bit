...
- ***Color adjustment*** - blend modes, alpha, brightness, contrast, hue, saturation, tint
...
- ***Export*** - save images in native file formats of each supported machine. Load your creations in emulators, on real hardware, or import them into compatible drawing apps like [Multipaint](http://multipaint.kameli.net) and [RetroPaint](https://www.beyond.dk/RetroPaint/), for further editing:
